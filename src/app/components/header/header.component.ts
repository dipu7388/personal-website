...
export const socialItemsArray: Array<{
...
}> = [
  {
    ...
    icon: 'fa fa-github',
    url: 'https://github.com/dipu7388',
  },
  {
    name: 'View Profile on Linkedin',
    icon: 'fa fa-linkedin',
    url: 'https://www.linkedin.com/in/dheerendra-kumar-singh/',
  },
  {
    name: 'Follow me on Twitter',
    icon: 'fa fa-twitter',
    url: 'https://twitter.com/dhirend92095087',
  },
  {
    name: 'Follow me on Facebook',
    icon: 'fa fa-facebook-f',
    url: 'https://www.facebook.com/dipusingh7388',
  },
  {
    name: 'Follow me on Instagram',
    icon: 'fa fa-instagram',
    url: 'https://www.instagram.com/dheeru.1194/',
  },
];
@Component({
  selector: 'dk-header',
...
export class HeaderComponent implements OnInit {
  ...
  @Input() set contactData(contact: Contact) {
    ...
    if (contact?.socialLinks) {
      this.socialItems = contact.socialLinks;
    } else {
      this.socialItems = socialItemsArray;
    }
  }
